...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, avrg_img_size=320, patch_size=10, in_chans=1, embed_dim=64, depth=8,
                 num_heads=9, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0., out_chans=None,
        ...
        self.head = nn.Linear(self.num_features, self.out_chans*self.patch_size[0]*self.patch_size[1]) 
    ...
    def seq2img(self, x, img_size):
        ...
        """
        x = x.view(x.shape[0], x.shape[1], self.out_chans, self.patch_size[0], self.patch_size[1])
